// Affiché instantanément pendant le chargement de la page "Ma Maison".
  ...
  return (
    <div className="min-h-screen bg-[#FDFCF8] font-sans pb-32 overflow-x-hidden">
      ...
      <main className="max-w-md mx-auto px-5 mt-6 relative z-20 space-y-6 animate-pulse">
        <div className="h-40 bg-white rounded-[1.5rem] border border-stone-100 shadow-sm" />
        <div className="h-56 bg-white rounded-[1.5rem] border border-stone-100 shadow-sm" />
        <div className="h-40 bg-white rounded-[1.5rem] border border-stone-100 shadow-sm" />
      </main>
    </div>
  );
